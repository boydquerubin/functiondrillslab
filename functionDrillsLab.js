...
//CODE HERE
// const jsNinja = (jsNinja) => 'I am a Javascript ninja!'; // *INITIAL ATTEMPT*
...
//CODE HERE
// function greeting(){ // *INITIAL ATTEMPT*
...
//CODE HERE
// let biggerNumber = x > y or y > x; // *INITIAL ATTEMPT - should get a laugh out of this in the future*
// const compareNums = (x, y) => biggerNumber;
...
//CODE HERE
// function add(Num1, Num2){ // *INITIAL ATTEMPT
//   console.log(add);
// }
...
//CODE HERE
// function nameCheck(name){ // *INITIAL ATTEMPT - should get a laugh out of this in the future*
//   if name = Steven {
...
//CODE HERE
// const printAllNames(namesArr.length){ // *INITIAL ATTEMPT
//   console.log();
// };
...
//CODE HERE
// function thatsOdd(number) { // *INITIAL ATTEMPT
//   console.log();
//   if (number === ) {
...
//CODE HERE
// const bestMovie = (${name}) => { // *INITIAL ATTEMPT
...
//CODE HERE
function bigOrSmallArray(arr) { // *INITIAL ATTEMPT
  const answers =[];
...
const sampleString = "Hi, my name is Kylo.";
...
const result1 = emailCheck('example@email.com');
const result2 = emailCheck('invalid-email'); 
...
// Example usage:
const goldAmount = 20; // Replace with the amount of gold you have
const totalFrogs = buyChocolateFrogs(goldAmount);
...
const goldAmount = 4;
const totalFrogs2 = buyChocolateFrogs2(goldAmount);
...
let bathroomScope = [rubberDuckDuck]
